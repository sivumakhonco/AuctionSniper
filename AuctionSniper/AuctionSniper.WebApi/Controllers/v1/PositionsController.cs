...
using AuctionSniper.Application.Features.Positions.Commands.DeletePositionById;
using AuctionSniper.Application.Features.Positions.Commands.UpdatePosition;
using AuctionSniper.Application.Features.Positions.Queries.GetPositionById;
...
namespace AuctionSniper.WebApi.Controllers.v1
{
	[ApiVersion("1.0")]
